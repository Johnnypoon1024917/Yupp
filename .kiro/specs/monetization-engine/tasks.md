...
- [ ] 1. Implement affiliate link utility
  - [ ] 1.1 Create `src/utils/affiliateLinks.ts` with `getAffiliateLink` and `extractCity` functions
  ...
  - [ ]* 1.2 Write property test: Category-to-platform mapping (Property 1)
  ...
  - [ ]* 1.3 Write property test: Unrecognized or missing primaryType returns null (Property 2)
  ...
  - [ ]* 1.4 Write property test: Affiliate URL round-trip validity (Property 3)
...
- [ ] 2. Checkpoint — Verify affiliate link utility
  - Ensure all tests pass, ask the user if questions arise.

- [ ] 3. Create click tracking infrastructure
  - [ ] 3.1 Create Supabase migration `supabase/migrations/0004_referral_clicks.sql`
  ...
  - [ ] 3.2 Create server action `src/actions/trackReferralClick.ts`
  ...
  - [ ]* 3.3 Write unit tests for `trackReferralClick`
...
- [ ] 4. Integrate affiliate buttons and social proof badge into PlaceSheet
  - [ ] 4.1 Add social proof badge to PlaceSheet header
  ...
  - [ ] 4.2 Add "Plan Your Visit" affiliate button section to PlaceSheet
  ...
  - [ ]* 4.3 Write unit tests for PlaceSheet monetization features
